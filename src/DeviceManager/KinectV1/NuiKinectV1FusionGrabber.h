...
class NuiKinectV1FusionGrabber
{
...
public:
	NuiKinectV1FusionGrabber();
	~NuiKinectV1FusionGrabber();

	bool								initializeKinectFusion(NUI_IMAGE_RESOLUTION depthResolution, NUI_IMAGE_RESOLUTION	colorResolution);
...
private:
	...
	HRESULT								FusePointCloud(LONGLONG currentDepthFrameTime, bool bHasColor);
	bool								readFrame(NuiCompositeFrame* pCompositeFrame, bool* bHasColor);
