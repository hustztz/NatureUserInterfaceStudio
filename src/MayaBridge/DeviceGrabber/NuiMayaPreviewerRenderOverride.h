...
class NuiMayaPreviewerRenderOverride : public MHWRender::MRenderOverride
{
private:
...
public:
	...
	NuiMayaPreviewerRenderOverride(const MString& name);
	virtual ~NuiMayaPreviewerRenderOverride();
	...
	bool updatePreviewerTexture(NuiFrameCacheImpl* pBuffer);
	bool refreshView();
...
protected:
	...
	bool updateDepthTexture(NuiFrameCacheImpl* pBuffer);
	bool updateColorTexture(NuiFrameCacheImpl* pBuffer);
...
{
public:
	PreviewTargetsOperation(const MString &name, NuiMayaPreviewerRenderOverride* theOverride);
...
protected:
	NuiMayaPreviewerRenderOverride *mOverride;
